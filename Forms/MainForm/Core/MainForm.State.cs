...
namespace MyManager
{
    public partial class MainForm : Form
    {
        ...
        private static readonly Color QueuePanelBackColor = Color.FromArgb(236, 239, 243); // #ECEFF3
        private static readonly Color QueuePanelDividerColor = Color.FromArgb(213, 217, 222); // #D5D9DE
        private static readonly Color QueueHeaderBackColor = Color.FromArgb(236, 239, 243); // #ECEFF3
        private static readonly Color QueueHeaderTextColor = Color.FromArgb(46, 54, 66); // #2E3642
        private static readonly Color QueueHeaderSecondaryTextColor = Color.FromArgb(110, 119, 133); // #6E7785
        private static readonly Color QueueHeaderOnlineIndicatorColor = Color.FromArgb(52, 211, 153); // #34D399
        private static readonly Color QueueHeaderOfflineIndicatorColor = Color.FromArgb(138, 147, 160); // #8A93A0
        private static readonly Color QueueStatusHoverBackColor = Color.FromArgb(227, 231, 236); // #E3E7EC
        private static readonly Color QueueStatusSelectedBackColor = Color.FromArgb(217, 222, 229); // #D9DEE5
        private static readonly Color QueueStatusSelectedTextColor = Color.FromArgb(46, 54, 66); // #2E3642
        private static readonly Color QueueActiveMarkerColor = Color.FromArgb(112, 128, 154); // #70809A
        private static readonly Color QueueTextColor = Color.FromArgb(46, 54, 66); // #2E3642
        private static readonly Color QueueCounterTextColor = Color.FromArgb(90, 102, 120); // #5A6678
        private static readonly Color QueueCounterZeroTextColor = Color.FromArgb(138, 147, 160); // #8A93A0
        private static readonly Color QueueCounterSelectedTextColor = Color.FromArgb(255, 255, 255);
        private static readonly Color QueueCounterSelectedZeroTextColor = Color.FromArgb(234, 238, 244);
        private static readonly Color QueueCounterPillBackColor = Color.FromArgb(216, 222, 230); // #D8DEE6
        private static readonly Color QueueCounterPillZeroBackColor = Color.FromArgb(231, 235, 240); // #E7EBF0
        private static readonly Color QueueCounterPillSelectedBackColor = Color.FromArgb(123, 136, 157); // #7B889D
        private static readonly Color QueueCounterPillSelectedZeroBackColor = Color.FromArgb(157, 168, 184);
