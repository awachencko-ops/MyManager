# MyManager: строгий план на текущий момент
...
4. Внедрена group-first модель (`SingleOrder`/`MultiOrder`) в backend и историю.
...
1. Полноценный multi-order UI (group/item визуализация и item-level действия).
