...
namespace MyManager
{
    public partial class MainForm : Form
    {
        ...
        private static readonly Color QueuePanelBackColor = Color.FromArgb(238, 243, 249); // #EEF3F9
        private static readonly Color QueuePanelDividerColor = Color.FromArgb(214, 224, 240); // #D6E0F0
        private static readonly Color QueueHeaderBackColor = Color.FromArgb(238, 243, 249); // #EEF3F9
        private static readonly Color QueueHeaderTextColor = Color.FromArgb(33, 48, 68); // #213044
        private static readonly Color QueueHeaderSecondaryTextColor = Color.FromArgb(96, 112, 137); // #607089
        private static readonly Color QueueHeaderOnlineIndicatorColor = Color.FromArgb(52, 211, 153); // #34D399
        private static readonly Color QueueHeaderOfflineIndicatorColor = Color.FromArgb(138, 151, 171); // #8A97AB
        private static readonly Color QueueStatusHoverBackColor = Color.FromArgb(226, 234, 245); // #E2EAF5
        private static readonly Color QueueStatusSelectedBackColor = Color.FromArgb(212, 225, 243); // #D4E1F3
        private static readonly Color QueueStatusSelectedTextColor = Color.FromArgb(33, 48, 68); // #213044
        private static readonly Color QueueActiveMarkerColor = Color.FromArgb(47, 111, 237); // #2F6FED
        private static readonly Color QueueTextColor = Color.FromArgb(33, 48, 68); // #213044
        private static readonly Color QueueCounterTextColor = Color.FromArgb(75, 94, 122); // #4B5E7A
        private static readonly Color QueueCounterZeroTextColor = Color.FromArgb(138, 151, 171); // #8A97AB
        private static readonly Color QueueCounterSelectedTextColor = Color.FromArgb(255, 255, 255);
        private static readonly Color QueueCounterSelectedZeroTextColor = Color.FromArgb(235, 243, 255);
        private static readonly Color QueueCounterPillBackColor = Color.FromArgb(214, 226, 242); // #D6E2F2
        private static readonly Color QueueCounterPillZeroBackColor = Color.FromArgb(229, 235, 244); // #E5EBF4
